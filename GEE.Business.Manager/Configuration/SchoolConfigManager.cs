...
namespace GEE.Business.Manager.Configuration
{
    public class SchoolConfigManager : ISchoolConfig
    {
        ...
        /// <returns></returns>
        public EnquiryModel GetAutoGeneraedNo(int navigationId)
        {
            ...
            schoolConfigs = schoolConfigs.Where(a => a.Navigationmenu_id == navigationId && a.configKey == "IsSystemGenerated" && a.configvalue == "True").ToList();
