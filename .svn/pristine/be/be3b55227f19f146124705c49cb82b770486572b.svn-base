...
namespace GEE.API.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            AuthenticationProperties properties = CreateProperties(user.UserName,user.SchoolID.ToString(),user.GroupID.ToString(),user.Sessionyear.ToString());
        ...
        public static AuthenticationProperties CreateProperties(string userName,string schoolId,string groupId,string sessionYear)
        {
